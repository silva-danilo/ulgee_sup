...
plot(z[,2], prob, type="n", ylim=c(0,0.7), xlab="gini", ylab="Fitted psewage", cex.axis=1.2, cex.lab=1.5)
...
prob.s <- exp(eta.s)/(1+exp(eta.s))
prob.i <- exp(eta.i)/(1+exp(eta.i))
plot(z[,4], prob, type="n", ylim=c(0,0.7), xlab="gini", ylab="Fitted psewage", cex.axis=1.2, cex.lab=1.5)
...
prob.s <- exp(eta.s)/(1+exp(eta.s))
prob.i <- exp(eta.i)/(1+exp(eta.i))
plot(z[,7], prob, type="n", ylim=c(0,0.7), xlab="gini", ylab="Fitted psewage", cex.axis=1.2, cex.lab=1.5)
